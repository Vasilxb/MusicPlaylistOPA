...
public class MusicPlaylistServiceImpl
    ...
    @Override
    public MusicPlaylist findMusicPlaylistById(
            MusicPlaylistId musicPlaylistId
    ) {

        return musicPlaylistRepository
                .findById(musicPlaylistId)
                .orElseThrow(() ->
                        new EntityNotFoundException(
                                "MusicPlaylist not found with id: "
                                        + musicPlaylistId
                        )
                );
    }
    ...
    @Override
    public List<MusicPlaylist> findMusicPlaylistByName(
            String musicPlaylistName
    ) {

        String needle =
                musicPlaylistName == null
                        ? ""
                        : musicPlaylistName.trim();
    ...
    @Override
    public MusicPlaylist createMusicPlaylist(
    ...
    @Override
    public MusicPlaylist updateMusicPlaylist(
            MusicPlaylistId musicPlaylistId,
            PlaylistName playlistName,
            Description description,
            String userId,
        ...
        MusicPlaylist musicPlaylist =
                findMusicPlaylistById(musicPlaylistId);

        verifyOwnership(musicPlaylist, userId);
    ...
    private void verifyOwnership(
        ...
        if (!musicPlaylist.UserId().equals(userId)) {
